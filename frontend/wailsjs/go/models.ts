export namespace main {
	...
	export class PlannedSlotData {
	    startTime: string;
	    duration: number;
	
	    static createFrom(source: any = {}) {
	        return new PlannedSlotData(source);
	    }
	...
	export class DashboardTask {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.plannedSlots = this.convertValues(source["plannedSlots"], PlannedSlotData);
